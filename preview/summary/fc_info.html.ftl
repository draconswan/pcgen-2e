...
<html>
	<head>
		<title>Fantasy Craft information sheet</title>
	</head>
	<body>
		<table cellpadding="1" cellspacing="0" border="0" width="100%" summary="Character Information">
			...
			<tr valign="top">
				<td>
					<table>
						<tr><td><img src="images/icon_hp.png"/></td><td>&nbsp;<b>Vitality:</b>&nbsp;${pcstring('HP')}</td></tr>
						<tr><td><img src="images/icon_hp.png"/></td><td>&nbsp;<b>Wounds:</b>&nbsp;${pcstring('ALTHP')}</td></tr>
...
<#else>
				...
				<td>
					<table>
<!--><td><tr><td><img src="images/icon_bod.png"/></td><td>&nbsp;<b>Favored:</b>&nbsp;${pcstring('FAVOREDLIST')}</td></tr>	-->
...
<#if (pcstring('RACETYPE') = "<none>")>
						<tr><td><img src="images/icon_bod.png"/></td><td>&nbsp;<b>Race Type:</b>&nbsp;None</td></tr>
<#else>
						<tr><td><img src="images/icon_bod.png"/></td><td>&nbsp;<b>Race Type:</b>&nbsp;${pcstring('RACETYPE')}</td></tr>
</#if>
				...
				<td>
					<table>
						...
						<tr><td><img src="images/icon_load.png"/></td><td>&nbsp;<b>Load(H):</b>&nbsp;${pcstring('WEIGHT.HEAVY')} ${pcstring('UNITSET.WEIGHTUNIT')}</td></tr>
						<tr><td><img src="images/icon_load.png"/></td><td>&nbsp;<b>Dead Lift:</b>&nbsp;${pcstring('WEIGHT.OVERHEAD')} ${pcstring('UNITSET.WEIGHTUNIT')}</td></tr>
						<tr><td><img src="images/icon_load.png"/></td><td>&nbsp;<b>Lower up:</b>&nbsp;${pcstring('WEIGHT.OFFGROUND')} ${pcstring('UNITSET.WEIGHTUNIT')}</td></tr>
...
<!--><tr><td><img src="images/icon_load.png"/></td><td>&nbsp;<b>Load(M):</b>&nbsp;${pcstring('WEIGHT.MEDIUM')} ${pcstring('UNITSET.WEIGHTUNIT')}</td></tr> -->
