...
<xsl:stylesheet
	...
	>
	<xsl:import href="killshot_master_a.xslt"/>
	...
	<myAttribs:myAttribs>
		...
		<ability_block.title><subattrib centre="" inverse=""/></ability_block.title>
		<ability_block.border padding="0.5pt"><subattrib border="" inverse=""/></ability_block.border>
		<ability_block.lightline><subattrib light=""/></ability_block.lightline>
		<ability_block.darkline><subattrib medium=""/></ability_block.darkline>
