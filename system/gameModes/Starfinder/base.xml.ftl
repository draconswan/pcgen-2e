...
<character>
	...
	<hit_points>
		...
		<starfinder>${pcstring('VAR.StarfinderSystem.INTVAL')}</starfinder>
...
<!-- Pathfinder 
	...
	<@abilityBlock category="Special Ability" nature="ALL" hidden=false typeName="SpecialAttack" nodeName="special_attack" />
	  ...
	  ====================================-->
	<scr_themes>
	<@abilityBlock category="Theme" nature="ALL" hidden=false typeName="Theme" nodeName="scr_theme" />
	</scr_themes>
	  ...
	  ====================================-->
	<scr_racial_traits>
	<@abilityBlock category="Racial Trait" nature="ALL" hidden=false typeName="Racial Trait" nodeName="scr_racial_trait" />
	</scr_racial_traits>
	  ...
	  ====================================-->
	<scr_class_features>
	<@abilityBlock category="Class Feature" nature="ALL" hidden=false typeName="Class Feature" nodeName="scr_class_feature" />
	</scr_class_features>
